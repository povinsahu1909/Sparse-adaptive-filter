...
%      
%     for i=1:sample %input index 1:5000
...
% % E4=(err4);
% figure;
% plot(1:length(x),10*log10(mean(E1)),1:length(x),10*log10(mean(E2)),1:length(x),10*log10(mean(E3)),1:length(x),10*log10(mean(E4)),1:length(x),10*log10(mean(E5)));
% legend('LMS','ZA-LMS','RZA-LMS','l0-LMS','PZA-LMS');
% xlabel('Iterations');
% ylabel('MSD (dB)');
% % figure;
% % plot(sys);
